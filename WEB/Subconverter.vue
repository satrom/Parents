    ...
    var data = {
      ...
      options: {
        clientTypes: {
         ...
         customBackend: {
          "云专属IPV4": "https://pter.xyz:100/sub?",
          "云专属IPV6":
            "https://subcon.pter.xyz/sub?",
          "云专属A":
            "https://tapi.herokuapp.com/sub?",
          "网络版A":
            "https://subcon.dlj.tf/sub?",
          "网络版B": "https://sub.id9.cc/sub?"
        },
        backendOptions: [
          { value: "https://pter.xyz:100/sub?" },
          { value: "https://subcon.pter.xyz/sub?" },
        ...
        remoteConfig: [
          {
            ...
            options: [
              {
                label: "ADGUARD",
                value: "https://raw.githubusercontent.com/satrom/Parents/master/Part.ini"
              }
            ]
          },
          {
